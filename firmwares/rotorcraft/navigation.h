...
extern bool_t NavKillThrottle();
extern bool_t NavResurrect();

//#define NavSetGroundReferenceHere() ({ nav_reset_reference(); FALSE; })
//#define NavSetAltitudeReferenceHere() ({ nav_reset_alt(); FALSE; })

extern bool_t NavSetGroundReferenceHere();
extern bool_t NavSetAltitudeReferenceHere();
...
extern bool_t NavSetWaypointHere(uint8_t _wp);
extern inline bool_t NavCopyWaypoint(uint8_t _wp1, uint8_t _wp2);
extern inline bool_t NavCopyWaypointPositionOnly(uint8_t _wp1, uint8_t _wp2);
...
extern bool_t NavStartDetectGround();
