...
static void put_bytes(struct pprz_transport *trans, struct link_device *dev,
                      enum TransportDataType type, enum TransportDataFormat format,
...
static int check_available_space(struct pprz_transport *trans, struct link_device *dev,
                                 uint8_t bytes)
{
